...
var (
	...
	// CKKSComplexParamsN15QP881 is an example parameter set for the `ckks` package with logN=15 and logQP=881.
	// These parameters instantiate `ckks` over the complex field with N/2 SIMD slots.
	...
	// CKKSRealParamsN15QP881 is an example parameter set for the `ckks` package with logN=15 and logQP=881.
	// These parameters instantiate `ckks` over the real field with N SIMD slots.
