...
import (
	...
	"github.com/hosseinabdinf/sherdal/pkg/old_fv/bettersine"
	"github.com/hosseinabdinf/sherdal/utils"
)

// HalfBootstrapper is a struct to stores a memory pool the plaintext matrices
// the polynomial approximation and the keys for the half-aes_bootstrapping.
...
func NewHalfBootstrapper(params *Parameters, hbtpParams *HalfBootParameters, btpKey BootstrappingKey) (hbtp *HalfBootstrapper, err error) {
	...
	if err = hbtp.CheckKeys(); err != nil {
		return nil, fmt.Errorf("invalid aes_bootstrapping key: %w", err)
	}
...
// newHalfBootstrapper is a constructor of "dummy" half-bootstrapper to enable the generation of aes_bootstrapping-related constants
// without providing a aes_bootstrapping key. To be replaced by a propper factorization of the aes_bootstrapping pre-computations.
