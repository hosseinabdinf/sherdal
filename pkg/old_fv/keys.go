...
import (
	"github.com/hosseinabdinf/sherdal/pkg/old_fv/rlwe"
)
...
// BootstrappingKey is a type for a CKKS aes_bootstrapping key, wich regroups the necessary public relinearization
