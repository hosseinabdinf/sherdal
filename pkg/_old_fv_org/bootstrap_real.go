...
// NewBootstrapperReal creates a new Bootstrapper.
...
// NewbootstrapperReal is a constructor of "dummy" bootstrapper to enable the generation of bootstrapping-related constants
