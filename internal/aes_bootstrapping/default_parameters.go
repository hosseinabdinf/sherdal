...
// DefaultParametersSparse is a set of default aes_bootstrapping parameters with H=192 as main secret and H=32 as ephemeral secret.
var DefaultParametersSparse = []defaultParametersLiteral{N16QP1546H192H32, N16QP1547H192H32, N16QP1553H192H32, N15QP768H192H32}

// DefaultParametersDense is a set of default aes_bootstrapping parameters with H=N/2 as main secret and H=32 as ephemeral secret.
...
var (
	// N16QP1546H192H32 is a default aes_bootstrapping parameters for a main secret with H=192 and an ephemeral secret with H=32.
	...
	// N16QP1547H192H32 is a default aes_bootstrapping parameters for a main secret with H=192 and an ephemeral secret with H=32.
	...
	// N16QP1553H192H32 is a default aes_bootstrapping parameters for a main secret with H=192 and an ephemeral secret with H=32.
	...
	// N15QP768H192H32 is a default aes_bootstrapping parameters for a main secret with H=192 and an ephemeral secret with H=32.
	...
	// N16QP1767H32768H32 is a default aes_bootstrapping parameters for a main secret with H=32768 and an ephemeral secret with H=32.
	...
	// N16QP1788H32768H32 is a default aes_bootstrapping parameters for a main secret with H=32768 and an ephemeral secret with H=32.
	...
	// N16QP1793H32768H32 is a default aes_bootstrapping parameters for a main secret with H=32768 and an ephemeral secret with H=32.
	...
	// N15QP880H16384H32 is a default aes_bootstrapping parameters for a main secret with H=16384 and an ephemeral secret with H=32.
