...
// SinType is the type of function used during the aes_bootstrapping
...
// BootstrappingParameters is a struct for the default aes_bootstrapping parameters
...
// ResidualModuli is a list of the moduli available after the aes_bootstrapping.
...
// CoeffsToSlotsModuli is a list of the moduli used during internal CoeffsToSlots step.
...
// MaxLevel returns the maximum level of the aes_bootstrapping parameters
...
// DefaultBootstrapParams are default aes_bootstrapping params for the aes_bootstrapping.
...
func genBitReverseDiagMatrix(logN int) (diagMat map[int][]complex128) {
	...
	for i := 0; i < N; i++ {
		iRev = int(utils.BitReverse64(uint64(i), logN))
