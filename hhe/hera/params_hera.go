...
var heraModDown80 = []pkg.ModDownPlan{
...
var heraModDown128 = []pkg.ModDownPlan{
...
var heraHalfBootPresets = []pkg.LegacyHalfBootParameters{
	{
		LogN:                16,
		LogSlots:            15,
		Scale:               1 << 40,
		...
		SineEvalModuli:      pkg.LegacySineEvalModuli{Qi: []uint64{0xfffffffff840001, 0x1000000000860001, 0xfffffffff6a0001, 0x1000000000980001, 0xfffffffff5a0001, 0x1000000000b00001, 0x1000000000ce0001, 0xfffffffff2a0001}, ScalingFactor: 1 << 60},
		CoeffsToSlotsModuli: pkg.LegacyCoeffsToSlotsModuli{Qi: []uint64{0x100000000060001, 0xfffffffff00001, 0xffffffffd80001, 0x1000000002a0001}, ScalingFactor: [][]float64{{0x100000000060001}, {0xfffffffff00001}, {0xffffffffd80001}, {0x1000000002a0001}}},
		H:                   192, SinType: pkg.LegacyCos1, MessageRatio: 512.0, SinRange: 25, SinDeg: 63, SinRescal: 2, ArcSineDeg: 0, MaxN1N2Ratio: 16.0,
	},
	{
		LogN:                16,
		LogSlots:            4,
