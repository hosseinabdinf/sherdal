...
// NewPlaintextCKKS NewPlaintext creates a new Plaintext of level and scale.
...
// NewPlaintextFV creates and allocates a new plaintext in RingQ (multiple moduli of Q).
...
// NewPlaintextFVLvl creates and allocates a new plaintext in RingQ (multiple moduli of Q)
// of given level.
// The plaintext will be in RingQ and scaled by Q/t.
// Slower encoding and larger plaintext size
