...
func TestAESCtr(t *testing.T) {
	...
	logger.PrintHeader("Testing AES CTR")
	...
	logger.PrintFormatted("Residual parameters: logN=%d, logSlots=%d, H=%d, sigma=%f, logQP=%f, levels=%d, scale=2^%d\n",
	...
	logger.PrintFormatted("Bootstrapping parameters: logN=%d, logSlots=%d, H(%d; %d), sigma=%f, logQP=%f, levels=%d, scale=2^%d\n",
	...
	logger.PrintMessage("Generating bootstrapping evaluation keys...")
	...
	fmt.Println("iv: ", iv)
	fmt.Println("sym key: ", symmetricKey)

	logger.PrintMessage("AES CKKS New()")
