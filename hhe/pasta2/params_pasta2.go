...
type Config struct {
	...
	BGVLogN         int
	UseResidualBGV  bool
	SymmetricParams sympasta2.Parameter
}

func DefaultPasta2Config(preset Preset, symParams sympasta2.Parameter) Config {
...
func (cfg Config) modDownPlan() pkg.ModDownPlan {
	return pasta2ModDown[cfg.Preset]
}

var pasta2ModDown = []pkg.ModDownPlan{
...
var pasta2HalfBootPreset = pkg.LegacyHalfBootParameters{
	LogN:                16,
	LogSlots:            15,
	Scale:               1 << 45,
	Sigma:               pkg.DefaultSigma,
	PlainModulus:        sympasta2.Pasta4Param1614.Modulus,
